...
func teaHandler(s ssh.Session) (tea.Model, []tea.ProgramOption) {
	...
	content, err := os.ReadFile("profiles/resume.md")
	if err != nil {
		log.Error("Could not read resume", "error", err)
	}
	out, _ := glamour.Render(string(content), "dark")
	m := model{
		term: pty.Term,
...
func (m model) headerView() string {
	title := titleStyle.Render("My Resume")
